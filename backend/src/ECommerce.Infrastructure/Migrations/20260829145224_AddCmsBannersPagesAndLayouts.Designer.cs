...
namespace ECommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260829145224_AddCmsBannersPagesAndLayouts")]
    partial class AddCmsBannersPagesAndLayouts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Domain.Content.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ECommerce.Domain.Content.CmsLayout", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_cms_layouts_tenant_id");

                    b.ToTable("cms_layouts", (string)null);
                });

            modelBuilder.Entity("ECommerce.Domain.Content.CmsLayoutSection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LayoutId")
                        .HasDatabaseName("ix_cms_layout_sections_layout_id");

                    b.ToTable("cms_layout_sections", (string)null);
                });

            modelBuilder.Entity("ECommerce.Domain.Content.Page", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ECommerce.Domain.Integrations.WebhookDeadLetterEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("EndpointId")
                        .HasDatabaseName("ix_webhook_dlq_endpoint_id");

                    b.HasIndex("EventType")
                        .HasDatabaseName("ix_webhook_dlq_event_type");

                    b.HasIndex("LastFailedAtUtc")
                        .HasDatabaseName("ix_webhook_dlq_last_failed");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_webhook_dead_letter_tenant_id");

                    b.HasIndex("ReplayedAtUtc", "LastFailedAtUtc")
                        .HasDatabaseName("ix_webhook_dlq_replayed_failed");

                    b.ToTable("webhook_dead_letter", (string)null);
                });
            ...
            modelBuilder.Entity("ECommerce.Domain.Tenants.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_SubscriptionPlans_tenant_id");
            ...
            modelBuilder.Entity("ECommerce.Domain.Tenants.TenantSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("ix_TenantSettings_tenant_id");

                    b.ToTable("TenantSettings", (string)null);
                });

            modelBuilder.Entity("ECommerce.Domain.Tenants.TenantSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId")
                        .IsUnique()
                        .HasDatabaseName("ix_TenantSubscriptions_tenant_id");

                    b.ToTable("TenantSubscriptions", (string)null);
                });

            modelBuilder.Entity("ECommerce.Domain.Wallets.LoyaltyTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerce.Domain.Wallets.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerce.Domain.Wallets.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerce.Domain.Content.CmsLayoutSection", b =>
                {
                    b.HasOne("ECommerce.Domain.Content.CmsLayout", null)
                        .WithMany("Sections")
            ...
            modelBuilder.Entity("ECommerce.Domain.Tenants.TenantSettings", b =>
                {
                    b.HasOne("ECommerce.Domain.Tenants.Tenant", null)
                        .WithOne("Settings")
                        .HasForeignKey("ECommerce.Domain.Tenants.TenantSettings", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("ECommerce.Domain.Tenants.TenantSubscription", b =>
                {
                    b.HasOne("ECommerce.Domain.Tenants.SubscriptionPlan", "Plan")
                        .WithMany()
                    ...
                    b.HasOne("ECommerce.Domain.Tenants.Tenant", null)
                        ...
                        .HasForeignKey("ECommerce.Domain.Tenants.TenantSubscription", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ECommerce.Domain.Wallets.LoyaltyTransaction", b =>
                {
                    b.HasOne("ECommerce.Domain.Wallets.Wallet", null)
