...
public sealed class ProductsController(ISender sender) : ControllerBase
{
    ...
    [HttpGet]
    [OutputCache(PolicyName = "TenantAware", Duration = 30, VaryByQueryKeys = ["page", "pageSize", "q", "categoryId", "brandId", "price.gte", "price.lte", "rating.gte", "locale", "currency"], VaryByHeaderNames = ["Accept-Language"])]
    ...
    [OutputCache(PolicyName = "TenantAware", Duration = 300, VaryByQueryKeys = ["locale", "currency"], VaryByHeaderNames = ["Accept-Language"])]
