...
|----|------|:------:|--------|
| US-I-004, US-I-006 | Refund workflow (policy + idempotent execution) | 6 | [ ] |
| US-I-005, US-I-007 | Reconciliation feed + financial audit trail | 4 | [ ] |
| US-B-007, US-B-008 | Bulk import + availability-aware catalog | 4 | [ ] |
| US-K-001, US-K-002, US-K-003, US-K-004 | Review submission + moderation + aggregation | 5 | [ ] |
| T-DAT-015 | Reconciliation job + drift flags | 4 | [ ] |
...
### Acceptance
- [ ] QAS-04 duplicate-execution test: refund never duplicates.
- [ ] Exceeds refundable → 422/409; restock atomic.
...
### Acceptance
- [ ] Recon run detects seeded drift; 0 undetected drift in report.
...
### Acceptance
- [ ] Import produces per-row error report; partial success supported.
...
### Acceptance
- [ ] Unverified cannot review; moderation enforces publish flow; aggregates correct.
...
## Sprint Exit
- [ ] Refunds never duplicate; nightly reconciliation reports 0 undetected drift; reviews moderated.
- [ ] US-I-004..007; US-B-007,008; US-K-001..004 green.
- [ ] CI green.
